    	...
    	if (data != "finished"){
	        ...
	        if (val == true){
	        	...
	        	if ("annotation_classes" in data){
	        		...
	        		$('#submitannotation3').val(data["annotation_classes"][2]["class_name"]);
	        		...
	        		$("#submitannotation3").css("background-color", data["annotation_classes"][2]["button_color_bg"]);
	        		...
	        		$("#submitannotation3").css("border-bottom-color", data["annotation_classes"][2]["button_color_border"]);
	        		...
	        		$("#submitannotation3").css("border-right-color", data["annotation_classes"][2]["button_color_border"]);
	        		class1_value = data["annotation_classes"][0]["annotation_value"]
	        		class2_value = data["annotation_classes"][1]["annotation_value"]
	        		class3_value = data["annotation_classes"][2]["annotation_value"]
	        	} else {
...
ajaxdata(true);
	...
	$("#submitannotation3").click(function() {
		current_item_annotation = class3_value;
		ajaxupdate();
	});
